...
public:
    ...
    /**
     * Returns the BRITE calculated coordinates for a given node.
     */
    Vector2D GetNodePosition(uint32_t nodeId);
...
private:
    ...
    std::unordered_map<uint32_t, BriteNodeInfo*> m_briteNodeInfoMap;
